...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
       ...
       ''函数参数必须严格保持一致性
        ...
        Declare Function dmc_download_memfile Lib "LTDMC.dll" (ByVal CardNo As Integer, ByRef pbuffer As Byte, ByVal buffsize As Long, ByRef pfilenameinControl As Byte, ByVal filetype As Integer) As Integer
       ...
       '3800,3600,5800,5600专用 一个手轮信号控制多轴运动
        ...
        Declare Function dmc_hcmp_2d_set_pwmoutput Lib "LTDMC.dll" (ByVal CardNo As Integer, ByVal hcmp As Integer, ByVal pwm_enable As Integer, ByVal duty As Double, ByVal freq As Double, ByVal pwm_number As Integer) As Integer
        Declare Function dmc_hcmp_2d_force_output Lib "LTDMC.dll" (ByVal CardNo As Integer, ByVal hcmp As Integer, ByVal outbit As Integer) As Integer
        ...
        Declare Function dmc_set_extra_encoder Lib "LTDMC.dll" (ByVal CardNo As Integer, ByVal channel As Integer, ByVal pos As Long) As Integer
        Declare Function dmc_get_extra_encoder Lib "LTDMC.dll" (ByVal CardNo As Integer, ByVal channel As Integer, ByRef pos As Long) As Integer
