...
namespace csLTDMC //命名空间根据应用程序修改
{
    ...
    public partial class LTDMC
    {
        ...
        **************************************************************/
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_m_add_posTrig_torque_movseg_data(ushort CardNo, ushort group, ushort axis, double torque, double PosLimitValue, ushort PosLimitValid, ushort PosMode, ushort trigAxis, double trigPos, ushort trigPosType, ushort trigMode, UInt32 mark);//位置触发转矩移动
