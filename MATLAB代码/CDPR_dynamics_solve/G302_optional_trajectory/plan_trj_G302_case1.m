% function [pose_trj, v_trj, a_trj, t_vec_G,t_end] = plan_trj_G302_case1( t_step)
% 
...
p_start1 = [0; -0.8; 0.4; 0; 0; 0];
p_end1 = [0; -R*cos(65/180*pi); p_start1(3)+R*sin(65/180*pi); 5/180*pi; 0; 0];
t_start1 = 0;  
t_end1 = 5;
...
p_start2 = p_end1;
p_end2 = [0; -R*cos(65/180*pi); p_start1(3)+R*sin(65/180*pi); -5/180*pi; 0; 0];
t_start2 = t_end1;  
t_end2 = 8;
[pose_trj2, v_trj2, a_trj2, t_vec_G2] = ...
    plan_trj_line(t_start2, t_step, t_end2, p_start2, p_end2);
