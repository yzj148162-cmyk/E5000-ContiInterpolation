function plot_trajectory_G302(result_trj_ee, base_g, result_trj_cable,ideal_a_g)
%% 读取绘图参数
% 读取末端轨迹
...
%% 初始化绘图
% 空间轨迹
space_plot = plot_init_spaceTrj_G302(ax_space, pose_ee, base_g,ideal_a_g);
...
for i = 1:size(t_vec,2)
    % 更新空间轨迹
    plot_update_spaceTrj_G302(space_plot, pose_ee(:,i), base_g, ideal_a_g(:,i),pose_ee(:,1:i));
