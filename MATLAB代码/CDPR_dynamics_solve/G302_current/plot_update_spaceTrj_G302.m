function plot_update_spaceTrj_G302(space_plot, ~, base_g,ideal_a_g,pose_ee_trj)
% 读取绘图句柄
...
set(trj_circle_ee_plot(10),'XData',ideal_a_g(33),'YData',ideal_a_g(34),'ZData',ideal_a_g(35),...
