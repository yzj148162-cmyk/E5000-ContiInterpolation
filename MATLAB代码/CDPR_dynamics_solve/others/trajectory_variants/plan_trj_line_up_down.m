function [pose_trj, v_trj, a_trj, t_vec_G,t_end] = plan_trj_line_up_down( t_step)




p_start1 = [0; 0; 2.5; 0; 0; 0];
p_end1 = [0; 0; 3.5; 0.1; 0.2; 0];
t_start1 = 0;  
t_end1 = 3;
