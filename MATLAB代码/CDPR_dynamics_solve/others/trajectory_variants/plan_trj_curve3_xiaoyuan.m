function [pose_trj1, v_trj1, a_trj1, t_vec_G1] = plan_trj_curve3_xiaoyuan(t_start1, t_step, t_end1, p_start1, p_end1, O_position)
...
%   a_trj1    - [ax, ay, az, alpadx, alphay, alphaz]
    ...
    for i = 1:N
        ...
        yaw_angle = atan2(vec_look(2), vec_look(1)) + pi/2.2;%
        % yaw_angle = 0;
