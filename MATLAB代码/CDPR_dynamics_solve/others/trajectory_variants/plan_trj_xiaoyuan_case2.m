...
p_start1 = [-3; -1; 1; 0; 0; 0];
p_end1 = [2.05; 2.5; 2.3; 0; 0; 0];
...
[pose_trj1, v_trj1, a_trj1, t_vec_G1] = ...
    plan_trj_oval_xiaoyuan(t_start1, t_step, t_end1, p_start1, p_end1,O_position);
  
p_start2 = pose_trj1(:,end);
p_end2 = [3; 1.55; 2.3; pose_trj1(4:6,end)];
t_start2 = t_end1;  
t_end2 = 25;
R = 0.95;
vec = [0 0 -1];
