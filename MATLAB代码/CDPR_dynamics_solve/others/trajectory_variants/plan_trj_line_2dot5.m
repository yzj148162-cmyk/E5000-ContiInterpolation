function [pose_trj, v_trj, a_trj, t_vec_G,t_end] = plan_trj_line_2dot5( t_step)



p_start1 = [0; 0; 0; 0; 0; 0];
% p_start1 = [0; 0; 0.7; -0.2; 0; 0];
% p_end1 = [0; 0; 0.7; 0.7; 0.192; -0.192];
p_end1 = [0; 0; 0.7; 0.65; 0; 0];
t_start1 = 0;  
t_end1 = 4;
