function [cable_force,num_vertex] = calculate_CFEL_Force(force_ee,moment_ee,jaco,force_min,force_max,ij_indx)
...
if i2 > 0
    ...
    title('张力可行域：张力空间8 组平行线（16 条完整直线）');
