function space_plot = plot_init_spaceTrj_erqi(ax, pose_ee, base_g,ideal_a_g)
%% 绘制轨道网格
% 读取轨道参数
...
i1=4;
j1=6;
trj_circle_ee_plot(10) = plot3(ax, [ideal_a_g(4*i1-3),ideal_a_g(4*j1-3)],[ideal_a_g(4*i1-2),ideal_a_g(4*j1-2)],[ideal_a_g(4*i1-1),ideal_a_g(4*j1-1)] , 'k','LineWidth',1.5);
i1=6;
j1=8;
trj_circle_ee_plot(11) = plot3(ax, [ideal_a_g(4*i1-3),ideal_a_g(4*j1-3)],[ideal_a_g(4*i1-2),ideal_a_g(4*j1-2)],[ideal_a_g(4*i1-1),ideal_a_g(4*j1-1)] , 'k','LineWidth',1.5);
i1=8;
j1=2;
trj_circle_ee_plot(12) = plot3(ax, [ideal_a_g(4*i1-3),ideal_a_g(4*j1-3)],[ideal_a_g(4*i1-2),ideal_a_g(4*j1-2)],[ideal_a_g(4*i1-1),ideal_a_g(4*j1-1)] , 'k','LineWidth',1.5);
...
% 使用 quiver3 绘制箭头
trj_circle_ee_plot(13) = quiver3(ax,ideal_a_g(33), ideal_a_g(34), ideal_a_g(35), ...
