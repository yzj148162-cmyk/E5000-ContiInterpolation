function plot_update_spaceTrj_erqi(space_plot, pose_ee, base_g,ideal_a_g,pose_ee_trj)
% 读取绘图句柄
...
i1=1;
j1=3;
set(trj_circle_ee_plot(1),'XData', [ideal_a_g(4*i1-3),ideal_a_g(4*j1-3)],'YData', [ideal_a_g(4*i1-2),ideal_a_g(4*j1-2)],'ZData', [ideal_a_g(4*i1-1),ideal_a_g(4*j1-1)]);
i1=3;
j1=5;
set(trj_circle_ee_plot(2),'XData', [ideal_a_g(4*i1-3),ideal_a_g(4*j1-3)],'YData', [ideal_a_g(4*i1-2),ideal_a_g(4*j1-2)],'ZData', [ideal_a_g(4*i1-1),ideal_a_g(4*j1-1)]);
i1=5;
j1=7;
set(trj_circle_ee_plot(3),'XData', [ideal_a_g(4*i1-3),ideal_a_g(4*j1-3)],'YData', [ideal_a_g(4*i1-2),ideal_a_g(4*j1-2)],'ZData', [ideal_a_g(4*i1-1),ideal_a_g(4*j1-1)]);
i1=7;
j1=1;
set(trj_circle_ee_plot(4),'XData', [ideal_a_g(4*i1-3),ideal_a_g(4*j1-3)],'YData', [ideal_a_g(4*i1-2),ideal_a_g(4*j1-2)],'ZData', [ideal_a_g(4*i1-1),ideal_a_g(4*j1-1)]);
i1=3;
j1=8;
set(trj_circle_ee_plot(5),'XData', [ideal_a_g(4*i1-3),ideal_a_g(4*j1-3)],'YData', [ideal_a_g(4*i1-2),ideal_a_g(4*j1-2)],'ZData', [ideal_a_g(4*i1-1),ideal_a_g(4*j1-1)]);
i1=2;
j1=5;
set(trj_circle_ee_plot(6),'XData', [ideal_a_g(4*i1-3),ideal_a_g(4*j1-3)],'YData', [ideal_a_g(4*i1-2),ideal_a_g(4*j1-2)],'ZData', [ideal_a_g(4*i1-1),ideal_a_g(4*j1-1)]);
i1=4;
j1=7;
set(trj_circle_ee_plot(7),'XData', [ideal_a_g(4*i1-3),ideal_a_g(4*j1-3)],'YData', [ideal_a_g(4*i1-2),ideal_a_g(4*j1-2)],'ZData', [ideal_a_g(4*i1-1),ideal_a_g(4*j1-1)]);
i1=1;
j1=6;
set(trj_circle_ee_plot(8),'XData', [ideal_a_g(4*i1-3),ideal_a_g(4*j1-3)],'YData', [ideal_a_g(4*i1-2),ideal_a_g(4*j1-2)],'ZData', [ideal_a_g(4*i1-1),ideal_a_g(4*j1-1)]);



% update_cylinder_between(trj_circle_ee_plot(5), ideal_a_g(41:43), ideal_a_g(45:47), 0.1);


i1=2;
j1=4;
set(trj_circle_ee_plot(9),'XData', [ideal_a_g(4*i1-3),ideal_a_g(4*j1-3)],'YData', [ideal_a_g(4*i1-2),ideal_a_g(4*j1-2)],'ZData', [ideal_a_g(4*i1-1),ideal_a_g(4*j1-1)]);
i1=4;
j1=6;
set(trj_circle_ee_plot(10),'XData', [ideal_a_g(4*i1-3),ideal_a_g(4*j1-3)],'YData', [ideal_a_g(4*i1-2),ideal_a_g(4*j1-2)],'ZData', [ideal_a_g(4*i1-1),ideal_a_g(4*j1-1)]);
i1=6;
j1=8;
set(trj_circle_ee_plot(11),'XData', [ideal_a_g(4*i1-3),ideal_a_g(4*j1-3)],'YData', [ideal_a_g(4*i1-2),ideal_a_g(4*j1-2)],'ZData', [ideal_a_g(4*i1-1),ideal_a_g(4*j1-1)]);
i1=8;
j1=2;
set(trj_circle_ee_plot(12),'XData', [ideal_a_g(4*i1-3),ideal_a_g(4*j1-3)],'YData', [ideal_a_g(4*i1-2),ideal_a_g(4*j1-2)],'ZData', [ideal_a_g(4*i1-1),ideal_a_g(4*j1-1)]);
...
set(trj_circle_ee_plot(13),'XData',ideal_a_g(33),'YData',ideal_a_g(34),'ZData',ideal_a_g(35),...
    'UData', ideal_a_g(37)-ideal_a_g(33), 'VData', ideal_a_g(38)-ideal_a_g(34), 'WData', ideal_a_g(39)-ideal_a_g(35));
