...
stop_mode );
        ...
        **************************************************************/
        ...
        [DllImport("LTDMC.dll")]
        public static extern short nmc_read_txpdo_extra_extend(UInt16 CardNo, UInt16 PortNum, UInt16 pdoNum, UInt16[] address,UInt16[] DataLen, Int32[] Value);
        //DMC_API short __stdcall nmc_read_txpdo_extra_extend(WORD CardNo, DWORD PortNum, DWORD pdoNum, DWORD* address, DWORD* DataLen, int* Value);
        [DllImport("LTDMC.dll")]
...
trigPosType, ushort[] trigMode, uint mark);//位置触发移动
        [DllImport("LTDMC.dll")]
...
ushort trigAxisNum, ushort[] trigAxisList, double[] trigPos, ushort[] trigPosType, ushort[] trigMode, uint mark);//多轴位置触发移动
        [DllImport("LTDMC.dll")]
...
ushort trigMode, ushort TrigINNum, ushort[] trigINList, ushort[] trigINstate, uint mark);//位置+io触发移动
        [DllImport("LTDMC.dll")]
...
ushort trigMode, uint mark);//位置触发移动
        [DllImport("LTDMC.dll")]
 ...
 process_mode, ushort trigAxis, double trigPos, ushort trigPosType, ushort trigMode, uint mark);//位置触发移动
        [DllImport("LTDMC.dll")]
...
Pos_Mode,long mark);
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_hcmp_2d_fifo_add_table_unit(UInt16 CardNo, UInt16 hcmp, UInt16 num, double[] x_cmp_pos, double[] y_cmp_pos, UInt16[] cmp_outbit);
        ...
        //TypeIndex:0~6  m_Averagetime ; 平均时间 m_Maxtime;最大时间 uint64  m_Cycles;当前时间
        [DllImport("LTDMC.dll")]
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_rtcp_set_workpiece_mode(ushort CardNo, ushort Crd, ushort enable, ushort workpiece_index);    //坐标系号0-3，使能哪个工件坐标系
        [DllImport("LTDMC.dll")]
        public static extern short dmc_rtcp_get_workpiece_mode(ushort CardNo, ushort Crd,ref ushort enable,ref ushort workpiece_index);    //坐标系号0-3，使能哪个工件坐标系
...
ushort trigPosType, ushort trigMode, UInt32 mark);//位置触发转矩移动
...
double slave_sync_pos,ref double master_start_dist,ref double velocity,ref double acc,ref double dec,ref double s_time,ref ushort buffer_mode);
       ...
       **********************************************************/
        ...
        public static extern short dmc_trace_get_data(ushort CardNo, int bufsize, byte[] data, ref int byte_size);
...
cutlength,ref double sync_start_pos,ref double sync_stop_pos,ref double rot_start_pos,ref double fed_stop_pos);
        ...
        [DllImport("LTDMC.dll")]
        public static extern short nmc_read_rxpdo_extra_short(ushort CardNo, ushort PortNum, ushort address, ushort DataLen, ushort[] Value);
        [DllImport("LTDMC.dll")]
        public static extern short nmc_read_txpdo_extra_short(ushort CardNo, ushort PortNum, ushort FirdtAddress, ushort DataLen,  ushort[] Value);
...
mark);    
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_set_alm_mode_ex(ushort CardNo, ushort axis, ushort enable, ushort alm_logic, ushort alm_action, ushort alm_all);//新增配置
        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_alm_mode_ex(ushort CardNo, ushort axis,ref ushort enable,ref ushort alm_logic,ref ushort alm_action,ref ushort alm_all);//新增配置
        ...
        public static extern short nmc_get_slave_state(ushort CardNo, ushort SlaveId,  ushort[] SlaveState);
        [DllImport("LTDMC.dll")]
        //public static extern short nmc_get_slave_present(ushort CardNo, ushort SlaveId, ref ushort Present);
        public static extern short nmc_get_slave_present(ushort CardNo, ushort SlaveId, byte[] Present);
        [DllImport("LTDMC.dll")]
...
posi_mode);
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_set_gear_follow_ratio(ushort CardNo, ushort axis, double ratio);//双Z轴
        [DllImport("LTDMC.dll")]
...
offset);
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_m_add_sigaxis_moveseg_data_extern(ushort CardNo, ushort group, ushort Axis, double Target_pos, ushort mode,UInt32 mark);
        [DllImport("LTDMC.dll")]
        ...
        ////正余弦振荡曲线运动
        [DllImport("LTDMC.dll")]
        public static extern short dmc_sine_oscillate_set_mode(ushort CardNo, ushort Axis, ushort mode);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_sine_oscillate_unit(ushort CardNo, ushort Axis, double Amplitude, double Frequency);
        [DllImport("LTDMC.dll")]
	   ...
	   [DllImport("LTDMC.dll")]
        ...
        public static extern short dmc_m_remain_space(ushort CardNo, ushort Crd, ref uint data);
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_set_ultra_profile_unit(UInt16 CardNo, UInt16 axis_no, UInt16 plan_mode, IntPtr vel_param, UInt16 acc_mode);

        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_ultra_profile_unit(UInt16 CardNo, UInt16 axis_no, ref UInt16 plan_mode, IntPtr vel_param, ref UInt16 acc_mode);

        [DllImport("LTDMC.dll")]
        public static extern short dmc_set_vector_ultra_profile_unit(UInt16 CardNo, UInt16 crd_no, UInt16 plan_mode, IntPtr vel_param, UInt16 acc_mode);

        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_vector_ultra_profile_unit(UInt16 CardNo, UInt16 crd_no, ref UInt16 plan_mode, IntPtr vel_param, ref UInt16 acc_mode);

        //区域碰撞限位功能说明
        [DllImport("LTDMC.dll")]
        public static extern short dmc_dual_2dmove_collisiondetection_set_param(UInt16 CardNo, UInt16[] AxisList, double[] rect1_list, double[] rect2_list, short[] axis_dir, double Rect2_angle, UInt16 enable, UInt16 stop_mode);
        
        [DllImport("LTDMC.dll")]
        public static extern short dmc_dual_2dmove_collisiondetection_get_param(UInt16 CardNo, UInt16[] AxisList, double[] rect1_list, double[] rect2_list, short[] axis_dir, ref double Rect2_angle, ref UInt16 enable, ref UInt16 stop_mode);
